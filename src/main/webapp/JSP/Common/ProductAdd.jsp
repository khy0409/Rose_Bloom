...
<div class="product-registration-form">
    <h2>새로운 상품 등록</h2>
    <form action="ProductAddProcess.jsp" method="post" enctype="multipart/form-data">
        <label for="productNum">Product Number</label>
        <input type="number" id="productNum" name="productNum" readonly value="<%= result %>">
